...
[jds, ml_A, ml_B] = pkl.load(open('../data/ml.pkl', 'rb'))

#ml_A = [ml_A]
#ml_B = [ml_B]
print ml_A
ml_A = -ml_A
peaks, properties = ss.find_peaks(ml_A, prominence=(0.0001,5), width=(1,1000))
print peaks


plt.plot(ml_A)
plt.plot(peaks, ml_A[peaks], "x")
plt.vlines(x=peaks, ymin=ml_A[peaks] - properties["prominences"],ymax = ml_A[peaks], color = "C1")
...
#peak_fitting(LC[10], time, delta,map_conv, showplot=True)
